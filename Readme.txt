...
To use the project : login with "test" and password "pwd123". Add tasks and save.  If tasks are changed / removed / added, refresh the page to see that the previous tasks were indeed cached.